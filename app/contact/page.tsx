  ...
  const slides = [
    {
      ...
      description:
        "Whether you are a researcher, a patient, or a professional looking to join our mission, we are here to provide the information you need."
    },
    {
      id: 2,
      ...
      description:
        "Our state-of-the-art facilities are dedicated to accelerating the development of life-saving therapeutics for patients worldwide."
    },
    {
      id: 3,
      ...
      description:
        "Partnering with leading health organizations to ensure equitable access to next-generation genomic treatments across the globe."
    },
    {
      id: 4,
...
const ContactForm = () => {
  ...
  return (
    ...
    >
      <h3 className="text-3xl font-bold text-[#000d21] mb-6">
        General Inquiry
      </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-2">
            <label
              ...
              className="text-sm font-medium text-[#44474d]"
            >
  ...
  >
    ...
    <div className="space-y-8 grow">
      ...
      <div className="flex gap-4 group">
        ...
        <div>
          <h4 className="text-xl font-bold text-[#000d21]">
            Hahobal Biopharmaceuticals India Pvt. Ltd.
          </h4>
          <p className="text-[#44474d] mt-1 leading-relaxed">
            NO 201 Swaroop Aditya Avenue,
            <br />
            Marol Pipeline Road, International Airport,
            <br />
            Kranti Nagar, Andheri East,
            <br />
      ...
      <div className="flex gap-4 group">
        ...
        <div>
          ...
          <p className="text-[#44474d] mt-1 leading-relaxed">
            Sales:{" "}
            <a
              href="mailto:sales@hahoballifesciences.com"
              className="text-[#006a63] hover:underline"
            >
              sales@hahoballifesciences.com
            </a>
          </p>
          <p className="text-[#44474d] mt-1 leading-relaxed">
            Support:{" "}
            <a
              href="mailto:support@hahoballifesciences.com"
              className="text-[#006a63] hover:underline"
            >
              support@hahoballifesciences.com
            </a>
          </p>

          {/* Improved WhatsApp Section */}
          <div className="mt-5">
            <a
              href="https://wa.me/919840070222"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 border-2 border-[#006a63] text-[#006a63] font-medium rounded-full hover:bg-[#006a63] hover:text-white transition-all duration-300 group/wa"
            >
              <WhatsAppIcon className="w-5 h-5 group-hover/wa:scale-110 transition-transform duration-300" />
              <span>+91 98400 70222</span>
            </a>
          </div>
        </div>
      </div>
